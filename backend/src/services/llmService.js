...
const LOCALIZED_FALLBACKS = {
  Hindi: {
    worker: {
      title: '{city} में आपका स्वागत है! 🌸',
      message: 'नमस्ते {name} जी, {city} में आपका स्वागत है! आपका SBI खाता देशव्यापी है। घर पैसे भेजने (Remittance) और स्थानीय UPI भुगतान तुरंत चालू करने के लिए यहाँ क्लिक करें। हम आपकी सुविधा के लिए यहाँ हैं।',
    },
    student: {
      title: '{city} में आपका स्वागत है! 🎓',
      message: 'नमस्ते {name}, नए शहर {city} में आपकी पढ़ाई के सफर की शुभ शुरुआत! SBI स्टूडेंट सेविंग्स अकाउंट, तुरंत डिजिटल डेबिट कार्ड और आसान पॉकेट मनी ट्रांसफर का लाभ उठाने के लिए यहाँ टैप करें।',
    }
  },
  Kannada: {
    worker: {
      title: '{city}ಗೆ ಸುಸ್ವಾಗತ! 🌸',
      message: 'ನಮಸ್ತೆ {name} ಅವರೇ, {city}ಗೆ ಸುಸ್ವಾಗತ! ನಿಮ್ಮ SBI ಖಾತೆಯು ದೇಶಾದ್ಯಂತ ಕಾರ್ಯನಿರ್ವಹಿಸುತ್ತದೆ. ಮನೆಗೆ ಸುಲಭವಾಗಿ ಹಣ ಕಳುಹಿಸಲು (Remittance) ಮತ್ತು ಸ್ಥಳೀಯ UPI ಪಾವತಿಗಳನ್ನು ಸಕ್ರಿಯಗೊಳಿಸಲು ಇಲ್ಲಿ ಕ್ಲಿಕ್ ಮಾಡಿ.',
    },
    student: {
      title: '{city}ಗೆ ಸುಸ್ವಾಗತ! 🎓',
      message: 'ನಮಸ್ತೆ {name}, {city}ನಲ್ಲಿ ನಿಮ್ಮ ವಿದ್ಯಾಭ್ಯಾಸದ ಪಯಣಕ್ಕೆ ಶುಭ ಹಾರೈಕೆಗಳು! ತ್ವರಿತ SBI ವಿದ್ಯಾರ್ಥಿ ಉಳಿತಾಯ ಖಾತೆ, ಡಿಜಿಟಲ್ ಡೆಬಿಟ್ ಕಾರ್ಡ್ ಪಡೆಯಲು ಮತ್ತು ಪೋಷಕರಿಂದ ಸುಲಭವಾಗಿ ಹಣ ಪಡೆಯಲು ಇಲ್ಲಿ ಕ್ಲಿಕ್ ಮಾಡಿ.',
    }
  },
  English: {
    worker: {
  ...
  Telugu: {
    worker: {
      title: '{city}కు సుస్వాగతం! 🌸',
      message: 'నమస్తే {name} గారు, {city}కు సుస్వాగతం! మీ SBI ఖాతా దేశవ్యాప్తంగా పనిచేస్తుంది. మీ ఇంటికి సులభంగా డబ్బు పంపడానికి (Remittance) మరియు స్థానిక UPI చెల్లింపులను ప్రారంభించడానికి ఇక్కడ క్లిక్ చేయండి.',
    },
    student: {
      title: '{city}కు సుస్వాగతం! 🎓',
      message: 'నమస్తే {name}, {city}లో మీ విద్యా ప్రయాణానికి శుభాకాంక్షలు! SBI స్టూడెంట్ సేవింగ్స్ ఖాతా, ఉచిత డిజిటల్ డెబిట్ కార్డ్ పొందడానికి మరియు సులభంగా పాకెట్ మనీ ట్రాన్స్‌ఫర్ కోసం ఇక్కడ క్లిక్ చేయండి.',
    }
  }
};
